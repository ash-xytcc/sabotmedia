...
function hostComparisonTable(esc) {
  ...
  return `<figure class="host-comparison"><figcaption><strong>Hosting provider comparison</strong><span>3 = strong · 2 = workable with meaningful trade-offs · 1 = limited for this use · ? = not sufficiently verified</span></figcaption><div class="host-comparison__scroll" tabindex="0" role="region" aria-label="Hosting provider comparison table"><table><thead><tr><th scope="col">Provider</th><th scope="col">Model / price (USD)</th><th scope="col">Control</th><th scope="col">Privacy &amp; data minimization</th><th scope="col">Resilience &amp; recovery</th><th scope="col">Movement accountability</th><th scope="col">NoBlogs / WordPress fit</th></tr></thead><tbody>${cells}</tbody></table></div><p class="host-comparison__note">Prices are shown in U.S. dollars. FlokiNET and Koumbit amounts are approximate USD conversions checked 2026-09-25; verify the provider’s current billed amount before paying. Scores are not totals and should not be added into a winner. Different projects need different trade-offs.</p><p class="host-comparison__note">Systemli is intentionally omitted from this NoBlogs replacement chart at its request because its service model is not a self-service NoBlogs equivalent.</p></figure>`
}
