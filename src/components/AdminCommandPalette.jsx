...
const COMMANDS = [
  ...
  { label: 'Editor Roles', description: 'Inspect collaboration role records', to: adminRoutes.roles, keywords: ['roles', 'permissions', 'collaboration'] },
  ...
  { label: 'Backups', description: 'Export a verified server-backed system snapshot', to: adminRoutes.backup, keywords: ['export', 'backup', 'snapshot'] },
  { label: 'Audit Log', description: 'Review recent persisted site changes', to: adminRoutes.auditLog, keywords: ['history', 'changes'] },
  { label: 'Sites & Domains', description: 'Track hostnames and Cloudflare attachment state', to: adminRoutes.sites, keywords: ['domain', 'hostname', 'dns', 'cloudflare'] },
  { label: 'Tools', description: 'Open operational utilities', to: adminRoutes.tools, keywords: ['utilities', 'rss', 'backup'] },
  { label: 'Settings', description: 'Open production-backed site settings', to: adminRoutes.settings, keywords: ['configuration'] },
  { label: 'Users', description: 'Manage individual accounts and access', to: adminRoutes.users, keywords: ['account', 'auth', 'rbac'] },
]
