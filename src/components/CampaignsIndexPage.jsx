...
const HUB_URL = 'https://sabot.media/campaigns'
...
export function CampaignsIndexPage() {
  ...
  async function shareHub() {
    if (navigator.share) {
      try { await navigator.share({ title: 'Sabot Media Campaigns', text: 'Current Sabot Media campaigns, reporting, and ways to act.', url: HUB_URL }); return } catch { /* fall back to copy */ }
    }
