...
function SignatureModerationCard({ item, checked, onToggle, onAct, onResend }) {
  ...
  const [draft, setDraft] = useState(() => ({ displayName: item.displayName || '', affiliation: item.affiliation || '', organizationName: item.organizationName || '', role: item.role || '', website: item.website || '', publicStatement: item.publicStatement || '' }))
