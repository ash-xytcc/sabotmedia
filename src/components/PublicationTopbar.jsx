      ...
      <div className="publication-topbar__inner">
        <div className="publication-topbar__brand">
          ...
          <nav className="publication-topbar__nav" aria-label="Primary">
            ...
            <EditableLink className="publication-topbar__investigations-link" labelField="nav.investigations.label" hrefField="nav.investigations.href" defaultLabel="Investigations" defaultHref={publicRoutes.investigations} />
