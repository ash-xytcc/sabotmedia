...
const TEST_LINE = 'Sabot Media. This is the local robot reader. No cloud speech service is involved.'
    ...
    <section className="wp-meta-box robot-voice-settings" aria-labelledby="robot-voice-settings-title">
      <div className="robot-voice-settings__header">
        <div>
          ...
          <p className="description">Site-wide local formant speech. No account or remote TTS service.</p>
        </div>
