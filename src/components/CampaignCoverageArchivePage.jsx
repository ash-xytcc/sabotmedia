    ...
    <main className="page campaign-coverage-page">
      ...
      <section className="campaign-coverage-results">
        <div className="campaign-coverage-shell">
          ...
          {state.error ? <div className="campaign-coverage-error"><strong>Coverage archive unavailable</strong><p>{state.error}</p><Link to="/campaigns/autistici-inventati">The campaign hub remains available →</Link></div> : null}
