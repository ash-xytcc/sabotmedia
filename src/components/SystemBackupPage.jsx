...
export function SystemBackupPage() {
  ...
  async function handleExport() {
    try {
      ...
      if (!nextSummary.feedSettingsIncluded || !nextSummary.publicConfigIncluded) throw new Error('Backup manifest is missing required settings datasets')
    ...
    <AdminFrame>
      <main className="page wp-admin-screen system-backup-page">
        ...
        <section className="wp-meta-box">
          ...
          <p className="description">Includes native content and D1 revision history, taxonomy, safe user identity/role metadata, legacy editor-role records, audit events, media metadata, collections, publications, Sites &amp; Domains, persisted feed settings, and public-site configuration.</p>
