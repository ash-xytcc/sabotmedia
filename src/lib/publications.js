...
export function createPublication(overrides = {}) {
  ...
  return {
    ...
    edition: 'Reader edition', coverImage: '', coverAlt: '', backCover: '', frontMatter: '', credits: 'Sabot Media', colophon: '',
...
export function generatePublicationFromPieces(publication, pieces = []) {
  ...
  pages.push(createPage('back-cover', pages.length, { title: 'Back Cover', blocks: [createTextBlock({ x: 80, y: 120, width: 620, height: 540, text: source.backCover || source.description || 'Sabot Media', fontSize: 28 })] }))
