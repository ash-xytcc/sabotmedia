...
export function readingDocument(title, body) {
  ...
  </style><div class="ns-wrap"><a href="#reading-content">Skip to content</a><nav aria-label="Plain HTML navigation">${nav.map(([url,label]) => link(url,label)).join(' ')}</nav><main id="reading-content"><p>Plain HTML reading view</p>${body}</main><footer>Ⓐ Intellectual property is bullshit – steal this website.</footer></div></noscript>`
}
