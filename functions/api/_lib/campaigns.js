...
export function defaultAiCampaign() {
  return normalizeCampaign({
    ...
    summary: 'Sabot Media and We Will Free Us are independently documenting and opposing the treatment of resistant communications infrastructure as terrorism. This page gathers the campaign in one place and will remain as a public archive after the deadline.',
    ...
    updates: [
      { id: 'update-launch', date: '2026-08-28T21:30:00Z', title: 'Campaign hub launched', body: 'Sabot Media and We Will Free Us consolidated reporting, letters, graphics, infrastructure status, and campaign updates into one public page.', url: '', pinned: true },
    ],
    resources: [],
    social: [],
    graphics: [],
    ...
    faq: [
      ...
      { id: 'faq-affiliation', question: 'Is Sabot Media affiliated with A/I?', answer: 'No. Sabot Media and We Will Free Us are independent publishers and campaign organizers. They do not represent or speak for A/I.' },
...
export function normalizeCampaign(input = {}) {
  ...
  return {
    ...
    social: normalizeRows(input.social, ['platform', 'date', 'account', 'excerpt', 'url', 'imageUrl']),
    graphics: normalizeRows(input.graphics, ['title', 'imageUrl', 'alt', 'caption', 'downloadUrl']),
    coverage: normalizeRows(input.coverage, ['date', 'outlet', 'title', 'url', 'summary']),
