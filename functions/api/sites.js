...
export async function onRequestGet(context) {
  ...
  try {
    ...
    const result = await context.env.BF_DB.prepare(`
      SELECT id, name, domain, base_path, status, notes, created_at, updated_at
      FROM site_domains
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    await context.env.BF_DB.prepare(`
      INSERT INTO site_domains (id, name, domain, base_path, status, notes, created_at, updated_at)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
