...
export async function onRequestPost(context) {
  try {
    ...
    await upsertGallery(db, {
      ...ABERDEEN_1312_GALLERY,
      description: 'Historical Aberdeen Local 1312 image archive migrated from the original Sabot Media Noblogs site.',
...
function htmlPage({ gallery = null, storageBinding = '', error = '' }, status = 200) {
  ...
  const body = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Aberdeen 1312 Gallery Migration</title><style>
